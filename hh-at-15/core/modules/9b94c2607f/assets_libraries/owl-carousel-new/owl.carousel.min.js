...
!(function (h, n, s, a) {
  ...
  function c(t, e) {
    (this.settings = null),
      (this.options = h.extend({}, c.Defaults, e)),
      (this.$element = h(t)),
      (this._handlers = {}),
      (this._plugins = {}),
      (this._supress = {}),
      ...
      (this.getItemWidth = function () {
        ...
        return (
          this.settings.item_size_gap && (t += this.settings.item_size_gap), t
        );
      }),
      (this._states = {
        current: {},
  ...
  (c.Defaults = {
    ...
    (c.Workers = [
      {
        ...
        run: function () {
          (this._width = Math.floor(this.$element.width())),
            l("set total width this._width: " + this._width);
        },
      },
      {
      ...
      },
      {
        filter: ["width", "items", "settings"],
        run: function (t) {
          !0 === this.settings.debug && (o = !0),
            l("run!"),
            1 == this.settings.items &&
              1 == this.settings.pixel_gap_fix &&
              ((this.settings.item_size_gap = 1), l("set items size gap: 1")),
            l("settings - stage padding type: " + this.settings.paddingType),
            l("settings - stage padding: " + this.settings.stagePadding),
            (this.settings.paddingType &&
              "none" != this.settings.paddingType) ||
              !this.settings.stagePadding ||
              ((this.settings.paddingType = "both"),
              l("set stage padding type - both"));
          var e,
            i = this.getItemWidth();
          for (
            l("Item width: " + i),
              this.settings.stagePadding > i &&
                ...
                (e = this.getItemWidth()),
                (this.settings.stagePadding = Math.floor(0.5 * e)),
                (i = this.getItemWidth()),
                l(
                  "set new stagePadding: " +
                    this.settings.stagePadding +
                    " and item width: " +
                    i
                )),
            ...
            (merge = this._mergers[iterator]),
              (merge =
                ...
                merge),
              (t.items.merge = 1 < merge || t.items.merge),
      ...
      },
      {
        ...
        run: function () {
          for (
            ...
            var n =
              (s[i - 1] || 0) +
              (this._widths[this.relative(i)] + this.settings.margin) * t;
            s.push(n);
          }
      ...
      },
      {
        ...
        run: function () {
          var t = this.settings.stagePadding,
            ...
            s = this.$stage.parent(),
            n = s.width();
          l("parent Outer Stage Width: " + s.width()),
            l("element width this.$element.width(): " + this.$element.width());
          var o = {
            ...
            n = { width: n };
          l("set outer stage css"),
            l(n),
            "none" == i
              ? (this.$stage.css(o), s.width(n))
              : "both" == i
              ? (this.$stage.css(r),
                s.css(n),
                l("Set stage width css (both)"),
                l(r))
              : "left" == i
              ? (this.$stage.css(a),
                s.css(n),
                l("Set stage width css (left)"),
                l(a))
              : "right" == i &&
                (this.$stage.css(t),
                s.css(n),
                l("Set stage width css (right)"),
                l(t));
        },
      },
      {
      ...
      },
      {
        ...
        run: function () {
          var t,
            ...
            h = [];
          for (
            ("left" != this.settings.paddingType &&
              "right" != this.settings.paddingType) ||
              (o = this.settings.stagePadding),
              i = 0,
          ...
          if (
            ...
            if (
              ...
              0 == this.settings.disableNoncenteredLinks)
            )
              return !1;
            var l = this.$stage.children().not(".center").find("a"),
              c = this.$stage.find(".center a");
            l.css({ cursor: "default", "pointer-events": "none" }),
              c.css({ cursor: "", "pointer-events": "" });
          }
        },
      },
      {
        ...
        run: function () {
          var t;
          this.settings.setActiveClass &&
            this.settings.setActiveClass &&
            ((t = !0),
            this.settings.setActiveClassOnMobile
              ? 1 == this.$stage.children(".active").length && (t = !0)
              : this.settings.setActiveClassOnMobile ||
                (1 == this.$stage.children(".active").length && (t = !1)),
            1 == t
              ? this.$stage
                  .children()
                  .eq(this.current())
                  .addClass("uc-active-item")
                  .siblings()
                  .removeClass("uc-active-item")
              : 0 == t && this.$stage.children().removeClass("uc-active-item"));
        },
      },
    ]),
    ...
    (c.prototype.initialize = function () {
      ...
      this.enter("initializing"),
        ...
        this.settings.autoWidth &&
          ...
          (i = this.settings.nestedItemSelector
            ...
            : a),
          (i = this.$element.children(i).width()),
      ...
      this.$stage.children().each(function () {
        ...
        var t,
          e = jQuery(this),
          i = e.find("img");
        (1 != i.hasClass("lazyloading") &&
          1 != i.hasClass("lazy-loaded") &&
          1 != i.hasClass("lazy-hidden")) ||
          (i.removeClass("lazyloading"),
          i.removeClass("lazy-loaded"),
          i.removeClass("lazy-hidden"),
          (t = i.data("src")) && i.attr("src", t),
          (t = "data-src"),
          jQuery.removeData(i, t));
    ...
    (c.prototype.prepare = function (t) {
      ...
      return (
        e.data ||
          (e.data = h("<" + this.settings.itemElement + "https://www.heirsholdings.com/>")
      ...
      switch ((t = t || c.Width.Default)) {
        ...
        default:
          switch (this.settings.paddingType) {
            case "left":
            case "right":
              l("calc width with stagePadding: " + this.settings.paddingType),
                (e =
                  this._width -
                  this.settings.stagePadding +
                  this.settings.margin);
            ...
            case "both":
              ...
              break;
            default:
              (e = this._width + this.settings.margin),
                l("calc width without stagePadding for dimention: " + t);
          }
      }
    ...
    (c.prototype.refresh = function () {
      l("---------------------refresh carousel-----------------------"),
        l("window width: " + n.innerWidth),
        l("element width: " + this.$element.width()),
        l("stage width: " + this.$stage.width()),
    ...
    (c.prototype.maximum = function (t) {
      ...
      if (n.loop) o = this._clones.length / 2 + this._items.length - 1;
        ...
        if ((e = this._items.length))
          for (
            i = this._items[--e].width(), s = Math.floor(this.$element.width());
    ...
    (c.prototype.scrollToTop = function (t, e) {
      jQuery("html, body").animate({ scrollTop: t + e }, 400);
    }),
    (c.prototype.scrollToHead = function () {
      ...
      var t = this.$element;
      if (
        0 == this.settings.scrollToHeadForceOnMobile &&
        1 == this.isElementInViewport(t)
      )
        return !1;
  ...
  (function (c, e) {
    ...
    (i.Defaults = { video: !1, videoHeight: !1, videoWidth: !1 }),
      ...
      (i.prototype.thumbnail = function (e, t) {
        ...
        "youtube" === t.type
          ? ((n = "https://www.heirsholdings.com//img.youtube.com/vi/" + t.id + "https://www.heirsholdings.com/hqdefault.jpg"), i(n))
          : "vimeo" === t.type
          ? c.ajax({
              type: "GET",
              url: "https://www.heirsholdings.com//vimeo.com/api/v2/video/" + t.id + ".json",
              jsonp: "callback",
              dataType: "jsonp",
              success: function (t) {
          ...
          : "vzaar" === t.type &&
            c.ajax({
              type: "GET",
              url: "https://www.heirsholdings.com//vzaar.com/api/videos/" + t.id + ".json",
              jsonp: "callback",
              dataType: "jsonp",
              success: function (t) {
      ...
      (i.prototype.play = function (t) {
        ...
        this._playing ||
          ...
          "youtube" === i.type
            ? t.attr(
                "src",
                "https://www.heirsholdings.com//www.youtube.com/embed/" +
                  i.id +
                  "?autoplay=1&rel=0&v=" +
                  i.id
              )
            : "vimeo" === i.type
            ? t.attr("src", "https://www.heirsholdings.com//player.vimeo.com/video/" + i.id + "?autoplay=1")
            : "vzaar" === i.type &&
              t.attr(
                "src",
                "https://www.heirsholdings.com//view.vzaar.com/" + i.id + "https://www.heirsholdings.com/player?autoplay=true"
              ),
          c(t)
            ...
            if (o) {
              if (
                (i
                  ...
                  .addClass(o),
                "none" == jQuery("." + o).css("animation-name"))
              )
                return void this.core.speed(t);
              (t =
      ...
      (this._core = t),
        ...
        (this._handlers = {
          "change.owl.carousel": s.proxy(function (t) {
            void 0 !== t.property &&
              "position" === t.property.name &&
              1 == this._core.settings.autoplay &&
            ...
            t.namespace && "settings" === t.property.name
              ...
              : t.namespace &&
                ...
                (this._call = n.setTimeout(
                  s.proxy(this._next, this, this._core.settings.autoplaySpeed),
    ...
    (i.Defaults = {
      ...
      (i.prototype.autoplay_device = function () {
        ...
        var e = this._core.viewport(),
          i = 767 < e;
        1 == e <= 767 && "desktop" == t && this.stop(),
          1 == i && "mobile" == t && this.stop();
      }),
  ...
  (function (n) {
    ...
    var e = function (t) {
      ...
      (this._handlers = {
        ...
        "mousewheel wheel DOMMouseScroll MozMousePixelScroll": n.proxy(
          function (t) {
            if (0 == this._core.settings.mousewheelControl) return !0;
            var e = this.$element;
            0 == i &&
              (0 < t.originalEvent.deltaY && 0 == i && e.trigger("next.owl"),
              t.originalEvent.deltaY < 0 && 0 == i && e.trigger("prev.owl"),
              (i = !0)),
    ...
    (e.Defaults = {
      ...
      (e.prototype.initialize = function () {
        ...
        for (t in ((this._controls.$relative = s.navContainer
          ? n(s.navContainer)
          : n("<div>").addClass(s.navContainerClass).appendTo(this.$element)),
        (this._controls.$previous = n(
          "<" + s.navElement + ' value="previous item" title="previous item">'
        )
        ...
        (this._controls.$next = n(
          "<" + s.navElement + ' value="next item" title="next item">'
        )
        ...
        s.changeItemOnClick &&
          ((i = (e = this)._core.clones().length / 2),
          setTimeout(function () {
            e._core.$stage.children().on(
              "click",
              n.proxy(function (t) {
        ...
        (this._controls.$absolute = s.dotsContainer
          ? n(s.dotsContainer)
          : n("<div>").addClass(s.dotsClass).appendTo(this.$element)),
      ...
      (e.prototype.draw = function () {
        ...
        (0 != t.nav && 0 != this._core.items().length && 0 != s.length) ||
          this._controls.$relative.remove(),
          1 == t.nav &&
            (this._controls.$previous.toggleClass(
              "disabled",
              !i && e <= this._core.minimum(!0)
            ),
            this._controls.$next.toggleClass(
              "disabled",
              !i && e >= this._core.maximum(!0)
            )),
          (0 != t.dots && 0 != this._core.items().length && 0 != s.length) ||
          ...
          t.dots &&
            ...
            t.dotsData && 0 != s
              ...
              ? this._controls.$absolute.append(
                  new Array(1 + s).join(this._templates[0])
                )
