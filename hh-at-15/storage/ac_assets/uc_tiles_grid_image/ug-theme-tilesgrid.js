...
function UGTheme_tilesgrid() {
  ...
  function setHtml() {
    ...
    if (g_options.theme_navigation_type == "arrows") {
      var htmlAdd =
        "<div class='ug-tile-navigation-wrapper' style='position:absolute'>";
      var svgArrowsNext =
        '<svg width="10" height="18" viewBox="0 0 10 18" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M3 3L8 9L3 15" stroke="' +
        g_options.theme_navigation_arrows_icon_color +
        '" stroke-width="3" stroke-miterlimit="10" stroke-linecap="square"https://www.heirsholdings.com/></svg>';
      var svgArrowsPrev =
        '<svg width="10" height="18" viewBox="0 0 10 18" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M7 15L2 9L7 3" stroke="' +
        g_options.theme_navigation_arrows_icon_color +
        '" stroke-width="3" stroke-miterlimit="10" stroke-linecap="square"https://www.heirsholdings.com/></svg>';
      ...
      htmlAdd +=
        "<div class='ug-button-tile-navigation ug-button-tile-left " +
        buttonTileCustomClass +
        "'>" +
        svgArrowsPrev +
        "</div>";
      htmlAdd +=
        "<div class='ug-button-tile-navigation ug-button-tile-right " +
        buttonTileCustomClass +
        "'>" +
        svgArrowsNext +
        "</div>";
    ...
    //add preloader
    g_objWrapper.append(
      "<div class='ug-tiles-preloader ug-preloader-trans'></div>"
    );
  ...
  function positionElements() {
    ...
    if (numPanes > 1) {
      ...
      if (g_objBullets) {
        ...
        var bulletsX =
          g_objGridSize.left +
          g_functions.getElementRelativePos(
            bulletsWidth,
            g_options.theme_navigation_align,
            g_options.theme_navigation_offset_hor,
            gridElement
          );

        g_functions.placeElement(
          bulletsElement,
          bulletsX,
          galleryHeight + g_options.theme_bullets_margin_top
        );
      ...
      if (g_objNavWrapper) {
        ...
        g_functions.placeElement(
          g_objNavWrapper,
          navX,
          galleryHeight + g_options.theme_arrows_margin_top
        );
  ...
  function initEvents() {
    ...
    g_objGallery.on(
      g_gallery.events.GALLERY_BEFORE_REQUEST_ITEMS,
      onBeforeReqestItems
    );
